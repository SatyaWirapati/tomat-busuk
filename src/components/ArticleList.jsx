const ArticleList = () => {
  const articles = [
    ...
    { 
      title: "Trailer Leak: Christopher Nolan’s ‘The Odyssey’ is His Scariest Film Yet", 
      category: "Exclusive", 
    ...
    { 
      title: "Review Film Avatar: The Way of Water", // <-- ARTIKEL KE-4 DITAMBAHKAN KEMBALI
      category: "Review", 
  ...
  return (
    // Catatan: Kelas h-full, overflow-y-auto, dan background harus diatur di Home.jsx
    <div className="p-4 md:p-0 w-full h-full flex flex-col">
      <h3 className="text-xl font-bold mb-4 text-red-700">
        📰 Artikel Terbaru
      </h3>
      
      {/* Menggunakan overflow-y-auto untuk mengizinkan scrolling jika terlalu banyak item */}
